...
!(function() {
  ...
  (b[0] = {
    value: function(a, c, d) {
      ...
      function f(a) {
        ...
        for (var b = 0; b < g.length; b++)
          "function" == typeof g[b] && g[b].call(this, this);
      }
      var g = [];
      return (
        (f.assemble = e),
    ...
    (b[5] = {
      value: function(a, b, c) {
        ...
        function e() {
          this.minder.supportClipboardEvent &&
            !kity.Browser.gecko &&
            (this.MimeType = new d());
        }
        return (
          (d.prototype.isPureText = function(a) {
          ...
          (d.prototype.whichMimeType = function(a) {
            return this.isPureText(a)
              ? null
              : this.getMimeType(a.split(this.getSpitor())[0]);
          }),
          (c.exports = e)
        );
      }
                ...
                if (document.activeElement == e.element) {
                  ...
                  switch (g) {
                    ...
                    case "normal":
                      ...
                      h.length &&
                        (f.clipboardData.setData("text/plain", a(h)),
                        b.execCommand("removenode")),
                        c.preventDefault();
                  }
                }
              },
        ...
        function e() {
          ...
          function b(a, b) {
            return a
              ...
              : ((t = u = !1), o && kity.releaseFrame(o), void (o = null));
          }
          var c = this.fsm,
            d = this.minder,
            e = this.hotbox,
            ...
            d.on("mousemove", function(a) {
              return (
                "drag" === c.state() &&
                  s == p &&
                  d.getSelectedNode() &&
                  (Math.abs(h - a.originEvent.clientX) > r ||
                    Math.abs(i - a.originEvent.clientY) > r) &&
                  ((l = a.originEvent.clientX),
                  (m = a.originEvent.clientY - n),
                  r > l
                    ? b("right", r - l)
                    : l > j - r
                    ? b("left", r + l - j)
                ...
                (Math.abs(h - a.originEvent.clientX) > r ||
                  Math.abs(i - a.originEvent.clientY) > r)
                  ? ("hotbox" === c.state() && e.active(f.STATE_IDLE),
                    c.jump("drag", "user-drag"))
                  : void 0
              );
            }),
        ...
        function f(a) {
          ...
          (this.jump = function(a, c) {
            ...
            for (d = 0; d < f.length; d++)
              if (
                ((g = f[d]), e(g.condition, "before", h, a) && g.apply(null, j))
              )
                return;
            for (
              b = a, i.log("[{0}] {1} -> {2}", c, h, a), d = 0;
              d < f.length;
              d++
            )
              (g = f[d]), e(g.condition, "after", h, a) && g.apply(null, j);
            return b;
          }),
            (this.state = function() {
              return b;
            ...
            (this.when = function(a, b) {
              ...
              if (
                ...
                2 == g.length
                  ? (e = "before")
                  : ((g = a.split(d)), 2 == g.length && (e = "after")),
                !e)
              )
                throw new Error("Illegal fsm condition: " + a);
              (h = g[0]),
                (i = g[1]),
                (b.condition = { when: e, exit: h, enter: i }),
                f.push(b);
            });
        }
        function g() {
      ...
      value: function(a, c, d) {
        function e() {
          var a = this.fsm,
            ...
            e = new f(d);
          e.setParentFSM(a),
            a.when("normal -> hotbox", function(a, c, d) {
              var f,
                g = b.getSelectedNode();
              if (g) {
          ...
          function f(a) {
            for (
              var b,
                ...
                h = /\S/,
                i = " ",
                k = new RegExp("( |" + String.fromCharCode(160) + ")"),
              ...
              switch (((b = a[p]), Object.prototype.toString.call(b))) {
                case "[object HTMLBRElement]":
                  e += g;
                  break;
                case "[object Text]":
                  if (((b = b.textContent.replace("&nbsp;", " ")), h.test(b)))
                    e += b;
                  else
                    for (d = b.length; d--; )
                      k.test(b[d]) ? (e += i) : b[d] === f && (e += f);
                  break;
                case "[object HTMLElement]":
                  ...
                  [].splice.apply(
                    a,
                    [p, 1].concat([].slice.call(b.childNodes))
                  ),
                    (q = a.length),
                    p--;
                  break;
                ...
                case "[object HTMLImageElement]":
                  b.src &&
                    /http(|s):\/\//.test(b.src) &&
                    m.execCommand("Image", b.src, b.alt);
                  break;
                case "[object HTMLDivElement]":
                  c = [];
                  for (var r = 0, q = b.childNodes.length; q > r; r++)
                    c.push(b.childNodes[r]);
                  c.push(l),
                ...
                default:
                  if (b && b.childNodes.length) {
                    ...
                    e += b && void 0 !== b.textContent ? b.textContent : "";
              }
            return (
              (e = e.replace(/^\n*|\n*$/g, "")),
              (e = e.replace(
              ...
              n
                ? m.queryCommandState("bold") || m.execCommand("bold")
                : m.queryCommandState("bold") && m.execCommand("bold"),
              o
                ? m.queryCommandState("italic") || m.execCommand("italic")
                : m.queryCommandState("italic") && m.execCommand("italic"),
              j(),
              e
            );
          ...
          function h(a, b) {
            try {
              ...
              if (
                (m.fire("contentchange"),
                m.getRoot().renderTree(),
                "Error: Invalid local format" !== c.toString())
              )
                throw c;
            }
          }
              ...
              (a.timer ||
                (a.timer = setTimeout(function() {
                  ...
                  (p.style.left = Math.round(c.x) + "px"),
                    (p.style.top =
                      (g.flaged ? Math.round(c.bottom + 30) : Math.round(c.y)) +
                      "px"),
                    (a.timer = 0);
                })));
          }
      ...
      value: function(a, c, d) {
        function e(a) {
          return a.ctrlKey || a.metaKey || a.altKey
            ...
            ? !0
            : 108 != a.keyCode && a.keyCode >= 96 && a.keyCode <= 111
            ? !0
            : 108 != a.keyCode && a.keyCode >= 96 && a.keyCode <= 111
            ? !0
            : 229 == a.keyCode || 0 === a.keyCode
            ? !0
            : !1;
        }
        function f() {
          ...
          c.listen("normal", function(d) {
            ...
            c.listen("hotbox", function(b) {
              ...
              h.dispatch(b);
              return h.state() == g.STATE_IDLE && "hotbox" == a.state()
                ? a.jump("normal", "hotbox-idle")
                : void 0;
            }),
            c.listen("input", function(b) {
              if ((c.enable(), "keydown" == b.type)) {
                if (b.is("Enter"))
                  return b.preventDefault(), a.jump("normal", "input-commit");
                if (b.is("Esc"))
                  return b.preventDefault(), a.jump("normal", "input-cancel");
          ...
          d.addEventListener(
            ...
            function(b) {
              b.button == k && b.preventDefault(),
                "hotbox" == a.state()
                  ? (h.active(g.STATE_IDLE), a.jump("normal", "blur"))
                  : "normal" == a.state() &&
                    b.button == k &&
                    ((i = b.clientX), (j = b.clientY));
            },
            !1
          ),
            d.addEventListener(
              ...
              function(b) {
                "hotbox" == a.state() &&
                  (h.active(g.STATE_IDLE), a.jump("normal", "mousemove-blur"));
              },
              !1
            ),
            d.addEventListener("contextmenu", function(a) {
              a.preventDefault();
            }),
            d.addEventListener(
              "mouseup",
              function(c) {
                "normal" == a.state() &&
                  ...
                  c.clientY == j &&
                  b.getSelectedNode() &&
                  a.jump("hotbox", "content-menu");
              },
              !1
            ),
            h.$element.addEventListener("mousedown", function(a) {
              a.stopPropagation();
            });
        }
        var g = b.r(2);
          ...
          h.forEach(function(a) {
            ...
            g.button({
              ...
              action: function() {
                ...
                0 === j.indexOf("Append")
                  ? (i++,
                    d.execCommand(j, "分支主题"),
                    d.on("layoutallfinish", a))
                  : (d.execCommand(j), f.jump("normal", "command-executed"));
              },
              enable: function() {
          ...
          function a(a) {
            a.is = function(a) {
              for (var b = a.split("|"), c = 0; c < b.length; c++)
                if (f.is(this, b[c])) return !0;
              return !1;
            };
            for (var c, d = 0; d < g.length; d++)
              if (
                ((c = g[d]),
                ("*" == c.notifyState || c.notifyState == b.state()) &&
                  c.call(null, a))
              )
                return;
          }
      ...
      value: function(a, c, d) {
        ...
        function g(a) {
          ...
          if (b) {
            var c = f(a) % 360,
              d = h(
                "background: hsl({0}, 50%, 80%); color: hsl({0}, 100%, 30%); padding: 2px 3px; margin: 1px 3px 0 0;border-radius: 2px;",
                c
              ),
    ...
    (b[20] = {
      value: function(a, b, c) {
        function d(a, b) {
          return (
            "object" != typeof b && (b = [].slice.call(arguments, 1)),
            String(a).replace(/\{(\w+)\}/gi, function(a, c) {
              return b[c] || c;
            })
          );
        }
    ...
    (b[22] = {
      value: function(a, b, c) {
        ...
        function f(a, b, c, g) {
          for (
            var i = h(b), j = h(a), k = !1, l = !1, m = j.length - 1;
            m >= 0;
            m--
          ) {
            var n = j[m],
            ...
            if (b.hasOwnProperty(n)) {
              ...
              null != p
                ...
                : o != p &&
                  ((k = !0),
                  c.push({ op: "replace", path: g + "/" + d(n), value: e(p) }));
            } else c.push({ op: "remove", path: g + "/" + d(n) }), (l = !0);
          }
          if (l || i.length != j.length)
            for (var m = 0; m < i.length; m++) {
              var n = i[m];
              a.hasOwnProperty(n) ||
                c.push({ op: "add", path: g + "/" + d(n), value: e(b[n]) });
            }
        }
        function g(a, b) {
          var c = [];
    ...
    (b[23] = {
      value: function(a, c, d) {
        ...
        function g(a) {
          var b = 0;
          if (
            ((a.ctrlKey || a.metaKey) && (b |= j),
            a.altKey && (b |= k),
            a.shiftKey && (b |= l),
            -1 === [16, 17, 18, 91].indexOf(a.keyCode))
          ) {
            if (229 === a.keyCode && a.keyIdentifier)
              return (b |= parseInt(a.keyIdentifier.substr(2), 16));
            b |= a.keyCode;
          }
          return b;
        }
  ...
  angular
                  ...
                  resolve: {
                    ...
                    defaultValue: function() {
                      var a = b.getSelectedNode(),
                        c = window.kityminder.data.getRegisterProtocol("text")
                          .Node2Text;
                      return c(a);
                    },
                    type: function() {
    ...
    angular.module("kityminderEditor").controller("hyperlink.ctrl", [
      ...
      function(a, b, c) {
        (a.R_URL = /(http|ftp|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:\/~\+#]*[\w\-\@?^=%&amp;\/~\+#])?/),
          ...
          (a.ok = function() {
            if (a.R_URL.test(a.url)) b.close({ url: a.url, title: a.title });
            else {
              a.urlPassed = !1;
              var c = $("#link-url");
        ...
        (a.title = c),
          ...
          (a.shortCut = function(b) {
            if (
              ...
              8 == b.keyCode && "export" == e && b.preventDefault(),
              9 == b.keyCode)
            ) {
              b.preventDefault();
              var c = b.target,
    ...
    angular.module("kityminderEditor").controller("image.ctrl", [
      ...
      function(a, b, c, d) {
        ...
        (b.data = {
          ...
          (b.ok = function() {
            if (b.data.R_URL.test(b.data.url))
              c.close({ url: b.data.url, title: b.data.title });
            else {
              b.urlPassed = !1;
              var a = $("#image-url");
              a.focus(), a[0].setSelectionRange(0, b.data.url.length);
        ...
        link: function(a) {
          ...
          (a.fontSizeList = [10, 12, 16, 18, 24, 32, 48]),
            ...
            (a.getFontfamilyName = function(b) {
              var c = "";
              return (
                a.fontFamilyList.forEach(function(a, d, e) {
          ...
          link: function(c, d, e) {
            ...
            if ("undefined" != typeof seajs)
              seajs.config({ base: "./src" }),
                define("demo", function(b) {
                  var d = b("editor"),
                    e = (window.editor = new d(g));
                  window.localStorage.__dev_minder_content &&
                    e.minder.importJson(
                      JSON.parse(window.localStorage.__dev_minder_content)
                    ),
                    e.minder.on("contentchange", function() {
      ...
      function(a, b) {
        return {
          ...
          link: function(c) {
              ...
              switch (a) {
                ...
                case "tianpan-compact":
                  return function(a, b, c, d, e) {
                    var f = d >> 1;
                    a.push("M", b, c + f, "a", f, f, 0, 1, 1, 0, 0.01, "z");
                  };
                default:
                  return function(a, b, c, d, e) {
              ...
              minder.getRoot().traverse(function(a) {
                ...
                q(c, b.x, b.y, b.width, b.height),
                  a.getConnection() &&
                    a.parent &&
                    a.parent.isExpanded() &&
                    d.push(a.getConnection().getPathData());
              }),
                k.setStyle("background", minder.getStyle("background")),
                c.length
                  ? l.fill(minder.getStyle("root-background")).setPathData(c)
                  : l.setPathData(null),
                d.length
                  ? m
            ...
            minder.setDefaultOptions({ zoom: b.getConfig("zoom") }),
    ...
    angular.module("kityminderEditor").directive("noteEditor", [
      "valueTransfer",
      function(a) {
        return {
          restrict: "A",
    ...
    angular.module("kityminderEditor").directive("notePreviewer", [
      "$sce",
      "valueTransfer",
      function(a, b) {
        return {
    ...
    angular.module("kityminderEditor").directive("priorityEditor", [
      "commandBinder",
      function(a) {
        return {
          restrict: "E",
          ...
          function(a) {
            ...
            function d() {
              (a.showSearch = !0),
                ...
                a.keyword &&
                  $("#search-input")[0].setSelectionRange(0, a.keyword.length);
            }
            function e() {
              (j = []),
            ...
            function f(a) {
              ...
              for (var b = 0; b < j.length; b++) {
                var c = j[b],
                  d = c.getText().toLowerCase();
                -1 != d.indexOf(a) && k.push({ node: c });
                var e = c.getData("note");
                e &&
                  -1 != e.toLowerCase().indexOf(a) &&
                  k.push({ node: c, keyword: a });
              }
            }
            function g(b, c) {
              function d(a, b) {
                h.execCommand("camera", a, 50),
                  setTimeout(function() {
                    h.select(a, !0),
                      ...
                      b && h.fire("shownoterequest", { node: a, keyword: b });
                  }, 60);
              }
              if (
                ((a.showTip = !1),
              ...
              if (
                ((g.lastKeyword = b),
                e && f(b),
                (a.resultNum = k.length),
                k.length)
              ) {
                var i = e
                  ? 0
                  : ("next" === c ? g.lastIndex + 1 : g.lastIndex - 1) || 0;
        ...
        link: function(a) {
          ...
          (a.getThemeThumbStyle = function(a) {
            ...
            if (c) {
              ...
              return (
                c["root-background"] &&
                  (d.background = c["root-background"].toString()),
                d
              );
            }
          }),
      ...
      return {
        ...
        link: function(a) {
          function b() {
            var a = $(".tab-content"),
              b = $(".minder-editor");
            a.animate({ height: 0, display: "none" }),
              b.animate({ top: "32px" });
          }
          function c() {
            var a = $(".tab-content"),
              b = $(".minder-editor");
            a.animate({ height: "60px", display: "block" }),
              b.animate({ top: "92px" });
          }
          var d = !1,
            e = !0,
