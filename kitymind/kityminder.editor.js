...
(function() {
  ...
  angular.module("kityminderEditor").run([
    "$templateCache",
    function($templateCache) {
      "use strict";

      $templateCache.put(
        "ui/directive/appendNode/appendNode.html",
      ...
      $templateCache.put(
        "ui/directive/arrange/arrange.html",
      ...
      $templateCache.put(
        "ui/directive/colorPanel/colorPanel.html",
      ...
      $templateCache.put(
        "ui/directive/expandLevel/expandLevel.html",
      ...
      $templateCache.put(
        "ui/directive/hyperLink/hyperLink.html",
      ...
      $templateCache.put(
        "ui/directive/imageBtn/imageBtn.html",
      ...
      $templateCache.put(
        "ui/directive/kityminderViewer/kityminderViewer.html",
      ...
      $templateCache.put(
        "ui/directive/navigator/navigator.html",
      ...
      $templateCache.put(
        "ui/directive/noteBtn/noteBtn.html",
      ...
      $templateCache.put(
        "ui/directive/noteEditor/noteEditor.html",
      ...
      $templateCache.put(
        "ui/directive/priorityEditor/priorityEditor.html",
      ...
      $templateCache.put(
        "ui/directive/progressEditor/progressEditor.html",
      ...
      $templateCache.put(
        "ui/directive/resourceEditor/resourceEditor.html",
      ...
      $templateCache.put(
        "ui/directive/searchBox/searchBox.html",
      ...
      $templateCache.put(
        "ui/directive/searchBtn/searchBtn.html",
      ...
      $templateCache.put(
        "ui/directive/selectAll/selectAll.html",
      ...
      $templateCache.put(
        "ui/directive/styleOperator/styleOperator.html",
      ...
      $templateCache.put(
        "ui/directive/templateList/templateList.html",
      ...
      $templateCache.put(
        "ui/directive/themeList/themeList.html",
      ...
      $templateCache.put(
        "ui/directive/undoRedo/undoRedo.html",
      ...
      $templateCache.put(
        "ui/dialog/hyperlink/hyperlink.tpl.html",
      ...
      $templateCache.put(
        "ui/dialog/imExportNode/imExportNode.tpl.html",
  ...
  angular.module("kityminderEditor").controller("hyperlink.ctrl", [
    "$scope",
    "$modalInstance",
    "link",
  ...
  angular.module("kityminderEditor").controller("imExportNode.ctrl", [
    "$scope",
    "$modalInstance",
    "title",
    "defaultValue",
    "type",
    function($scope, $modalInstance, title, defaultValue, type) {
      $scope.title = title;
  ...
  angular.module("kityminderEditor").controller("image.ctrl", [
    ...
    "$modalInstance",
    "image",
    function($http, $scope, $modalInstance, image) {
      $scope.data = {
        list: [],
        url: image.url || "",
        title: image.title || "",
          ...
          function($scope) {
            ...
            minder.on("interactchange", function() {
              ...
              var selected = enabled
                ? minder.queryCommandValue("resource")
                : [];
        ...
        return {
          link: function(scope, element, attrs) {
            var onClick = function(event) {
              var isChild =
                $("#resource-dropdown").has(event.target).length > 0;
        ...
        function($scope) {
          ...
          function doSearch(keyword, direction) {
            ...
            if (searchSequence.length) {
              ...
              curIndex =
                (searchSequence.length + curIndex) % searchSequence.length;
