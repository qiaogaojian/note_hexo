...
![Unity3D 脚本生命周期](http://upload-images.jianshu.io/upload_images/3947109-7e80f4bed6e2b23a.png)

### Unity 生命周期:[http://docs.unity3d.com/Manual/ExecutionOrder.html](http://docs.unity3d.com/Manual/ExecutionOrder.html)
...
而**OnBecameVisible** 和 **OnBecameInvisible** 是受对象是否可见的影响（如下）！即使脚本设置为不可用，**OnBecameVisible**和**OnBecameInvisible**也会被执行，主要是看对象是否在场景中显示了！
