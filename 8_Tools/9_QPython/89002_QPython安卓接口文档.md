...
> To simplify QPython SL4A development in IDEs with a “hepler” class derived from the default Android class containing SL4A(Script Layer for Android) facade functions & API documentation
...
![所有api](img/2019-08-22_164930.png)